...
[GQIMetaData(Name = "Add columns")]
public class AddColumnsOperator : IGQIRowOperator, IGQIColumnOperator, IGQIInputArguments
{
    private readonly GQIColumnListArgument _columnsArg;
    private IAdder _adder;

    /// <summary>
    /// Initializes a new instance of the <see cref="AddColumnsOperator"/> class.
